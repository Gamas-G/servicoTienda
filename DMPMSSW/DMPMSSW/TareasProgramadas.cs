...
namespace DMPMSSW
{
    ...
    public class EjecutarTarea : IJob
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            ...
            if (jobex == "MonitoreoSW") //Hora Especifica del día
            {
                Mtr.AgendarTarea(2, "CicloMtrSW", "triggerCMtrSW", string.Empty);
            }
            else if (jobex == "CicloMtrSW") //Se repite cada determinado tiempo mientras este activo el servicio
            {
                Mtr.MonitorSW();
            }
            else if (jobex == "MtrIniAlterSW") //Hora Especifica del día
            {
                Mtr.AgendarTarea(2, "CicloMtrSW", "triggerCMtrSW", string.Empty);
            }
        }
